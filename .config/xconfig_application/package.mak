...
override PKGDIR = xconfig_application
...
package/%.xdc.inc package/%_xconfig_application.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_application" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: application.pem4f

-include package/cfg/application_pem4f.mak
-include package/cfg/application_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/application_pem4f.dep
endif
application.pem4f: package/cfg/application_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
application.pem4f package/cfg/application_pem4f.c: .libraries,em4f
endif

package/cfg/application_pem4f.c package/cfg/application_pem4f.h package/cfg/application_pem4f.xdl: override _PROG_NAME := application.xem4f
package/cfg/application_pem4f.c: package/cfg/application_pem4f.cfg
package/cfg/application_pem4f.xdc.inc: package/cfg/application_pem4f.xdl
package/cfg/application_pem4f.xdl package/cfg/application_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/application_pem4f.cfg
	-$(RM) package/cfg/application_pem4f.dep
	-$(RM) package/cfg/application_pem4f.c
	-$(RM) package/cfg/application_pem4f.xdc.inc

clean,em4f::
	-$(RM) application.pem4f
.executables,em4f .executables: application.xem4f

application.xem4f: |application.pem4f

-include package/cfg/application.xem4f.mak
application.xem4f: package/cfg/application_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/application_pem4f.oem4f   package/cfg/application_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
application.xem4f: export C_DIR=
application.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
application.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

application.test test,em4f test: application.xem4f.test

application.xem4f.test:: application.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 application.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.application.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,application.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) application.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
application_pem4f.oem4f,copy : package/cfg/application_pem4f.oem4f
application_pem4f.sem4f,copy : package/cfg/application_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_application
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_application.tar.dep
endif
package/rel/xconfig_application/xconfig_application/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_application/xconfig_application/package/package.rel.xml: package/build.cfg
package/rel/xconfig_application/xconfig_application/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_application/xconfig_application/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_application.tar: package/rel/xconfig_application.xdc.inc package/rel/xconfig_application/xconfig_application/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_application.xdc.inc,package/rel/xconfig_application.tar.dep)


release release,xconfig_application: all xconfig_application.tar
clean:: .clean
	-$(RM) xconfig_application.tar
	-$(RM) package/rel/xconfig_application.xdc.inc
	-$(RM) package/rel/xconfig_application.tar.dep
